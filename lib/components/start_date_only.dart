...
///This is a custom widget [StartSelectionWidget] to allow user to choose end date and end times
...
class StartSelectionWidget extends StatefulWidget {
  ...
  @override
  _StartSelectionWidgetState createState() => _StartSelectionWidgetState();
}

class _StartSelectionWidgetState extends State<StartSelectionWidget> {
