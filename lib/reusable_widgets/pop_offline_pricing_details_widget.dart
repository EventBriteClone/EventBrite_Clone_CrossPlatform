...
/// This [OfflinePriceInfoPopUpWidget] takes as input [ticketPrice] and displays how the offline pricing works for the ticket in a [Container] displayed at [Center] of the screen as a pop up
...
class OfflinePriceInfoPopUpWidget extends StatelessWidget {
  OfflinePriceInfoPopUpWidget({super.key, required this.ticketPrice});
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: const BoxDecoration(
                                      ...
                                      color: Color.fromARGB(255, 95, 110, 241),
                                    ),
                                    child: const Icon(
                                      Icons.attach_money,
                                      color: Colors.white,
                                  ...
                                  Text(
                                    '\$${(double.parse(ticketPrice ?? ' ') - (0.029 * double.parse(ticketPrice ?? ' '))).toStringAsFixed(2)}',
                                    style: const TextStyle(
                                      fontWeight: FontWeight.w700,
                                      color: Color.fromARGB(206, 90, 90, 90),
                                      decoration: TextDecoration.none,
